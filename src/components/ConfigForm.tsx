    ...
    return (
        <div className="flex flex-col h-full">
            <div className="p-4 border-b dark:border-gray-700">
                <h2 className="text-xl font-semibold text-gray-800 dark:text-white">API 設定</h2>
            </div>
            ...
            <form className="flex-1 overflow-y-auto p-4 space-y-6 custom-scrollbar">
                <div className="space-y-4">
                    ...
                    <div className="form-group">
                        ...
                        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            回應的最大標記數量，1-4096之間。留空表示無限制
                        </p>
                    </div>

                    <div className="form-group">
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">top_p</label>
                        <input
                            type="number"
                            step="0.1"
                            {...register('top_p', {
                    ...
                    <div className="form-group">
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">top_k</label>
                        <input
                            type="number"
                            {...register('top_k', {
                    ...
                    <div className="form-group">
                        ...
                        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">搜尋結果的時間範圍限制</p>
                    </div>
